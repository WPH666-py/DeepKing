    ...
    <div class="sub-content">
      <div class="sub-form">
        ...
        <div class="form-group">
          ...
          <div class="dir-select-row">
            <div class="form-group" style="flex:1;margin-bottom:0">
              <input v-model="projectPath" placeholder="选择文件目录" readonly />
            </div>
        ...
        <div class="form-actions">
          ...
          <button class="btn btn-primary" @click="handleCreate" :disabled="!projectName || !projectPath || creating">
            {{ creating ? '创建中...' : '创建' }}
          </button>
        </div>
      </div>
...
async function handleCreate() {
  ...
  status.value = "";
  try {
    const result = await tauriAPI.createProject(projectName.value, projectPath.value);
    status.value = "项目创建成功！";
